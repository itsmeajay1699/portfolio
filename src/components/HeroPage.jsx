          ...
          <div className="md:min-w-[350px] w-full">
            ...
            <div className="masked-text">
              <p>
                ...
                experience in building dynamic, responsive, and user-friendly
                web applications. Skilled in both front-end and back-end
                development, I excel at turning complex ideas into seamless,
                functional digital products. My tech stack includes React.js,
                Next.js, Node.js, Express, and MongoDB, along with a strong
                foundation in database management and RESTful APIs.
              </p>
            </div>
          </div>
